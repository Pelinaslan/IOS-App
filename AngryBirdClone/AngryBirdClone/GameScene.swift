...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView)
    {
        ...
        bird.physicsBody?.collisionBitMask = ColliderType.Box.rawValue //collisions with box only
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        if contact.bodyA.collisionBitMask == ColliderType.Box.rawValue || contact.bodyB.collisionBitMask == ColliderType.Box.rawValue{
